...
cCallHistoryConnectTime = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 10, 25, 1, 4, 3, 1, 10), Integer()).setMaxAccess("readonly")
if mibBuilder.loadTexts: cCallHistoryConnectTime.setDescription("The value of sysUpTime when the call was connected.")
cCallHistoryDisconnectTime = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 10, 25, 1, 4, 3, 1, 11), Integer()).setMaxAccess("readonly")
